...
const postgres_1 = require("../helpers/postgres");
/**
...
function oldRefreshTokenRemoval() {
    return __awaiter(this, void 0, void 0, function*() {
        const postgresConnection = yield postgres_1.getConnection();
        try {
            yield dbQueries_1.deleteAllExpiredSessions(postgresConnection);
        } finally {
